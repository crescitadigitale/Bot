# Configuration file for CrescitaDigitale Bot - EXAMPLE
# Copy this file to config.py and modify with your settings
...
# 3. Replace the example IDs below with real ones
ADMIN_IDS = [
